...
function WebHeader() {
    ...
    return (
        <React.Fragment>
            <Navbar collapseOnSelect expand="lg" className="navbar-custom shadow-xl" fixed="top" style={{backgroundColor: '#454160', borderRadius: 10}}>
                <Container>
                    <Navbar.Brand as={Link} to="/" className="fw-bold text-white"><i className="fa fa-map-marked-alt"></i> SIPANTAI</Navbar.Brand>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav" style={{color: 'white'}}>
                        ...
                        <Nav>
                            ...
                            {token 
                                ? (
                                    <>
                                        <Link to="/admin/dashboard" className="btn btn-md btn-light text-uppercase me-2 mb-2">
                                            <i className="fa fa-user-circle"></i> {user.name}
                                        </Link>
                                        
                                        <button onClick={handleLogout} className="btn  btn-md btn-danger text-uppercase me-2 mb-2 ">
