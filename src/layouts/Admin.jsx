    ...
    return (
        <React.Fragment>
            <div className="d-flex sb-sidenav-toggled" id="wrapper" >
                <div className="" id="sidebar-wrapper" style={{backgroundColor: '#454160', borderRadius: 1}}>
                    <div className="sidebar-heading bg- text-center text-white">
                        <i className="fa fa-map-marked-alt"></i> <strong>SiPantai</strong>{" "}
                        <small>ADMIN</small>
                    </div>
                    <Sidebar />
                </div>
                <div id="page-content-wrapper">
                    <nav className="navbar navbar-expand-lg navbar-light bg- rounded" style={{backgroundColor: '#454160'}}>
                            ...
                            >
                                <ul className="navbar-nav ms-auto mt-2 mt-lg-0" >
                                    ...
                                    >
                                        ...
                                        <NavDropdown.Item as={Link} to="/admin/categories">
                                            <i className="fa fa-comment me-2"></i> Pengaduan
                                        </NavDropdown.Item>
